...
export function Chrome({ tag }: { tag?: string }) {
  ...
  return (
    <header
      className={`app-bar sticky top-0 z-20 flex items-center justify-between gap-4 border-b border-outline-variant bg-surface-bright/70 pb-[0.85rem] backdrop-blur-lg backdrop-saturate-150 ${PAD_X}`}
    >
