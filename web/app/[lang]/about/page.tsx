  ...
  return (
    <>
      ...
      <main className={`mx-auto w-full max-w-[60rem] py-[clamp(2rem,5vw,4rem)] ${PAD_X}`}>
        ...
        >
          gitstarclub indexes every public repo above 10,000 stars and reconstructs when each one rose — month by
          month, year by year, since 2015.
        </p>
        ...
        <Section heading="Where the data comes from">
          <p>
            ...
            (every public GitHub event since 2015). Current totals come from the official GitHub GraphQL &amp; Search
            APIs. We only show public data about public repositories.
          </p>
        </Section>

        <Section heading="The honest caveats">
          <p>
            <strong className="text-on-surface">Two measuring sticks.</strong> The historical curve counts <em>gross</em>{" "}
            stars added (GH Archive watch events); the live daily delta is <em>net</em> (it can go down when stars are
            removed). The seam between them is slightly inconsistent — star-history.com has the same limitation. Current
            totals are always anchored to the authoritative GitHub count.
          </p>
          <p>
            <strong className="text-on-surface">Survivor bias.</strong> We backfill only repos that are ≥10k stars{" "}
            <em>today</em>. Projects that rose and faded are missing from the history.
          </p>
          <p>
            <strong className="text-on-surface">Why 2015?</strong> Before late 2012, GitHub&rsquo;s &ldquo;watch&rdquo;
            wasn&rsquo;t the same as a star; data stabilizes in 2015, our start of the modern open-source era.
          </p>
        </Section>

        <Section heading="Time">
          <p>
            Everything is stored in UTC and aggregated on UTC day boundaries. Wherever an exact moment is shown, both
            UTC and JST (Japan time) appear — gitstarclub is made in Tokyo.
          </p>
        </Section>
