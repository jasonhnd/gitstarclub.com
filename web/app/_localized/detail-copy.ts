...
const TEXT: Record<Locale, DetailText> = {
  en: {
    ...
    categoryDetailDatasetDescription:
      "{label} repository rankings generated from deterministic category assignments, all-time ranking data, and repository lookup fields.",
    categoryDetailCollectionName: "{label} repositories",
    categoryDetailItemListName: "{label} repositories",
    categoryDetailCapsule:
      "As of {asOf}, GitStarClub tracks {count} repositories in {label}. {leader}{followers}. This category ranking uses deterministic category assignments, all-time ranking data, and repository lookup fields.",
    ...
    categoryDetailDataA: "GitStarClub combines deterministic category assignments, all-time ranking data, and repository lookup fields. The page does not call live search or AI.",
