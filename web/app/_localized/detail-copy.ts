...
const TEXT: Record<Locale, DetailText> = {
  en: {
    ...
    rankingDatasetDescription:
      "{label} GitHub repository rankings generated from precomputed Blob rank, lookup, and heatmap JSON where available.",
    ...
    rankingCapsule:
      "As of {asOf}, {title} ranks tracked GitHub repositories by {metric}. {leader}{followers}. GitStarClub generates this visible ranking from precomputed JSON and lookup joins, without runtime search, a database, or AI.",
    rankingWhatQ: "What does {title} rank?",
    rankingWhatAWithAsOf: "As of {asOf}, {title} ranks tracked GitHub repositories by {metric}.",
    rankingWhatANoAsOf: "{title} ranks tracked GitHub repositories by {metric} from precomputed rank JSON.",
    ...
    rankingDataA: "No. GitStarClub renders {title} from Blob rank JSON plus repository lookup JSON already loaded by the server route.",
    categoryIndexDatasetName: "GitStarClub Category Registry Dataset",
    categoryIndexDatasetDescription:
      "Public category dimensions, category counts, and crawlable category links generated from precomputed Blob category registry JSON.",
    ...
    categoryIndexCapsule:
      "As of {asOf}, GitStarClub organizes tracked GitHub repositories into {categories} public categories across {dimensions} dimensions, including {labels}. These links come from deterministic category registry JSON.",
    ...
    categoryIndexANoAsOf: "GitStarClub organizes tracked repositories into {categories} public categories across {dimensions} dimensions in the loaded registry JSON.",
    ...
    categoryCountsA: "Category counts come from deterministic category registry JSON generated from repository metadata and category rules, not from live search.",
    ...
    categoryDimensionDatasetDescription:
      "{label} category definitions, counts, and crawlable category links generated from precomputed Blob category registry JSON.",
    categoryDimensionCollectionName: "{label} categories",
    categoryDimensionItemListName: "{label} categories",
    categoryDimensionCapsule:
      "As of {asOf}, GitStarClub lists {categories} public categories in the {label} dimension for tracked GitHub repositories. This page is generated from category registry JSON with deterministic counts and crawlable links.",
    ...
    categoryDimensionANoAsOf: "The {label} page lists {categories} public categories for tracked GitHub repositories from registry JSON.",
    ...
    categoryLargestFallbackA: "No public {label} category counts are available in the loaded registry JSON.",
    ...
    categoryNoClientA: "No. The {label} page is server-rendered from Blob JSON and does not add client-side filtering logic for the visible FAQ or category links.",
    categoryDetailDatasetName: "GitStarClub {label} Repository Dataset",
    categoryDetailDatasetDescription:
      "{label} repository rankings generated from precomputed Blob category assignment, category rank, and repository lookup JSON.",
    categoryDetailCollectionName: "{label} repositories",
    categoryDetailItemListName: "{label} repositories",
    categoryDetailCapsule:
      "As of {asOf}, GitStarClub tracks {count} repositories in {label}. {leader}{followers}. This category ranking is generated from deterministic category assignment JSON, all-time ranking data, and repository lookup fields.",
    ...
    categoryDetailDataA: "GitStarClub combines category assignment JSON, all-time ranking data, and repository lookup fields. The page does not call live search or AI.",
  ...
  ja: {
    ...
    rankingDatasetDescription: "{label} の GitHub リポジトリランキング。利用可能な事前計算 Blob の rank、lookup、heatmap JSON から生成されます。",
    ...
    rankingCapsule:
      "{asOf} 時点で、{title} は追跡対象 GitHub リポジトリを{metric}で並べています。{leader}{followers}。GitStarClub は事前計算 JSON と lookup の結合からこのランキングを生成し、実行時検索、データベース、AI は使いません。",
    rankingWhatQ: "{title} は何をランキングしていますか？",
    rankingWhatAWithAsOf: "{asOf} 時点で、{title} は追跡対象 GitHub リポジトリを{metric}で順位付けしています。",
    rankingWhatANoAsOf: "{title} は事前計算 rank JSON から追跡対象 GitHub リポジトリを{metric}で順位付けします。",
    ...
    rankingDataA: "いいえ。GitStarClub はサーバールートで読み込まれた Blob rank JSON とリポジトリ lookup JSON から {title} をレンダリングします。",
    categoryIndexDatasetName: "GitStarClub カテゴリレジストリデータセット",
    categoryIndexDatasetDescription: "公開カテゴリの次元、カテゴリ数、クロール可能なカテゴリリンクを事前計算 Blob category registry JSON から生成します。",
    categoryIndexCollectionName: "GitHub リポジトリカテゴリ",
    categoryIndexItemListName: "GitHub リポジトリカテゴリ",
    categoryIndexCapsule:
      "{asOf} 時点で、GitStarClub は追跡対象 GitHub リポジトリを {dimensions} 個の次元、{categories} 個の公開カテゴリに整理しています。例: {labels}。これらのリンクは決定的な category registry JSON から作られます。",
    ...
    categoryIndexANoAsOf: "GitStarClub は読み込まれた registry JSON で追跡リポジトリを {dimensions} 個の次元、{categories} 個の公開カテゴリに整理します。",
    categoryDimensionsQ: "利用できるカテゴリ次元は？",
    categoryDimensionsA: "表示中のカテゴリ次元は {labels} です。",
    categoryCountsQ: "カテゴリ件数の出典は？",
    categoryCountsA: "カテゴリ件数は、リポジトリメタデータとカテゴリルールから生成された決定的な category registry JSON に由来し、ライブ検索ではありません。",
    ...
    categoryDimensionDatasetDescription: "{label} のカテゴリ定義、件数、クロール可能なカテゴリリンクを事前計算 Blob category registry JSON から生成します。",
    categoryDimensionCollectionName: "{label} カテゴリ",
    categoryDimensionItemListName: "{label} カテゴリ",
    categoryDimensionCapsule:
      "{asOf} 時点で、GitStarClub は追跡対象 GitHub リポジトリ向けに {label} 次元の公開カテゴリ {categories} 件を表示しています。このページは category registry JSON から決定的な件数とクロール可能なリンクを生成します。",
    ...
    categoryDimensionANoAsOf: "{label} ページは registry JSON から追跡 GitHub リポジトリ向けの公開カテゴリ {categories} 件を表示します。",
    categoryLargestQ: "{label} で最も追跡リポジトリが多いカテゴリは？",
    categoryLargestA: "{category} は表示中の {label} カテゴリで最大で、{count} 件の追跡リポジトリがあります。",
    categoryLargestFallbackA: "読み込まれた registry JSON に公開 {label} カテゴリ件数がありません。",
    ...
    categoryNoClientA: "いいえ。{label} ページは Blob JSON からサーバーレンダリングされ、表示 FAQ やカテゴリリンクにクライアント側フィルタを追加しません。",
    categoryDetailDatasetName: "GitStarClub {label} リポジトリデータセット",
    categoryDetailDatasetDescription: "{label} リポジトリランキングは、事前計算 Blob の category assignment、category rank、repository lookup JSON から生成されます。",
    categoryDetailCollectionName: "{label} リポジトリ",
    categoryDetailItemListName: "{label} リポジトリ",
    categoryDetailCapsule:
      "{asOf} 時点で、GitStarClub は {label} に {count} 件のリポジトリを追跡しています。{leader}{followers}。このカテゴリランキングは決定的な category assignment JSON、通算ランキングデータ、repository lookup から生成されます。",
    ...
    categoryDetailDataA: "GitStarClub は category assignment JSON、通算ランキングデータ、repository lookup を組み合わせます。このページはライブ検索や AI を呼び出しません。",
  ...
  zh: {
    ...
    rankingDatasetDescription: "{label} GitHub 仓库排名，由可用的预计算 Blob rank、lookup 和 heatmap JSON 生成。",
    ...
    rankingCapsule:
      "截至 {asOf}，{title} 按{metric}为已追踪 GitHub 仓库排名。{leader}{followers}。GitStarClub 从预计算 JSON 与 lookup 连接生成此可见排名，不使用运行时搜索、数据库或 AI。",
    rankingWhatQ: "{title} 排名的是什么？",
    rankingWhatAWithAsOf: "截至 {asOf}，{title} 按{metric}为已追踪 GitHub 仓库排名。",
    rankingWhatANoAsOf: "{title} 从预计算 rank JSON 中按{metric}为已追踪 GitHub 仓库排名。",
    ...
    rankingDataA: "不使用。GitStarClub 从服务器路由已加载的 Blob rank JSON 和仓库 lookup JSON 渲染 {title}。",
    categoryIndexDatasetName: "GitStarClub 分类注册表数据集",
    categoryIndexDatasetDescription: "公开分类维度、分类计数和可抓取分类链接由预计算 Blob category registry JSON 生成。",
    categoryIndexCollectionName: "GitHub 仓库分类",
    categoryIndexItemListName: "GitHub 仓库分类",
    categoryIndexCapsule:
      "截至 {asOf}，GitStarClub 将已追踪 GitHub 仓库整理为 {dimensions} 个维度下的 {categories} 个公开分类，包括 {labels}。这些链接来自确定性的 category registry JSON。",
    ...
    categoryIndexANoAsOf: "GitStarClub 在已加载的 registry JSON 中将已追踪仓库整理为 {dimensions} 个维度下的 {categories} 个公开分类。",
    categoryDimensionsQ: "有哪些分类维度？",
    categoryDimensionsA: "可见分类维度是 {labels}。",
    categoryCountsQ: "分类计数来自哪里？",
    categoryCountsA: "分类计数来自根据仓库元数据和分类规则生成的确定性 category registry JSON，而不是实时搜索。",
    ...
    categoryDimensionDatasetDescription: "{label} 分类定义、计数和可抓取分类链接由预计算 Blob category registry JSON 生成。",
    categoryDimensionCollectionName: "{label} 分类",
    categoryDimensionItemListName: "{label} 分类",
    categoryDimensionCapsule:
      "截至 {asOf}，GitStarClub 为已追踪 GitHub 仓库列出 {label} 维度下的 {categories} 个公开分类。该页面由 category registry JSON 生成确定性计数和可抓取链接。",
    categoryDimensionQ: "{label} 分类页包含什么？",
    categoryDimensionAWithAsOf: "截至 {asOf}，{label} 页面列出已追踪 GitHub 仓库的 {categories} 个公开分类。",
    categoryDimensionANoAsOf: "{label} 页面从 registry JSON 列出已追踪 GitHub 仓库的 {categories} 个公开分类。",
    categoryLargestQ: "哪个 {label} 分类的追踪仓库最多？",
    categoryLargestA: "{category} 是可见 {label} 分类中最大的一个，有 {count} 个追踪仓库。",
    categoryLargestFallbackA: "已加载的 registry JSON 中没有公开 {label} 分类计数。",
    ...
    categoryNoClientA: "不会。{label} 页面由 Blob JSON 服务器渲染，不为可见 FAQ 或分类链接添加客户端过滤逻辑。",
    categoryDetailDatasetName: "GitStarClub {label} 仓库数据集",
    categoryDetailDatasetDescription: "{label} 仓库排名由预计算 Blob category assignment、category rank 和 repository lookup JSON 生成。",
    categoryDetailCollectionName: "{label} 仓库",
    categoryDetailItemListName: "{label} 仓库",
    categoryDetailCapsule:
      "截至 {asOf}，GitStarClub 在 {label} 中追踪 {count} 个仓库。{leader}{followers}。该分类排名由确定性的 category assignment JSON、历史总榜数据和 repository lookup 字段生成。",
    ...
    categoryDetailDataA: "GitStarClub 组合 category assignment JSON、历史总榜数据和 repository lookup 字段。该页面不会调用实时搜索或 AI。",
  ...
  "zh-TW": {
    ...
    rankingDatasetDescription: "{label} GitHub 倉庫排名，由可用的預先計算 Blob rank、lookup 和 heatmap JSON 產生。",
    ...
    rankingCapsule:
      "截至 {asOf}，{title} 依{metric}為已追蹤 GitHub 倉庫排名。{leader}{followers}。GitStarClub 從預先計算 JSON 與 lookup 結合產生此可見排名，不使用執行時搜尋、資料庫或 AI。",
    rankingWhatQ: "{title} 排名的是什麼？",
    rankingWhatAWithAsOf: "截至 {asOf}，{title} 依{metric}為已追蹤 GitHub 倉庫排名。",
    rankingWhatANoAsOf: "{title} 從預先計算 rank JSON 中依{metric}為已追蹤 GitHub 倉庫排名。",
    ...
    rankingDataA: "不使用。GitStarClub 從伺服器路由已載入的 Blob rank JSON 和倉庫 lookup JSON 渲染 {title}。",
    categoryIndexDatasetName: "GitStarClub 分類註冊表資料集",
    categoryIndexDatasetDescription: "公開分類維度、分類計數和可抓取分類連結由預先計算 Blob category registry JSON 產生。",
    categoryIndexCollectionName: "GitHub 倉庫分類",
    categoryIndexItemListName: "GitHub 倉庫分類",
    categoryIndexCapsule:
      "截至 {asOf}，GitStarClub 將已追蹤 GitHub 倉庫整理為 {dimensions} 個維度下的 {categories} 個公開分類，包括 {labels}。這些連結來自確定性的 category registry JSON。",
    ...
    categoryIndexANoAsOf: "GitStarClub 在已載入的 registry JSON 中將已追蹤倉庫整理為 {dimensions} 個維度下的 {categories} 個公開分類。",
    categoryDimensionsQ: "有哪些分類維度？",
    categoryDimensionsA: "可見分類維度是 {labels}。",
    categoryCountsQ: "分類計數來自哪裡？",
    categoryCountsA: "分類計數來自根據倉庫中繼資料和分類規則產生的確定性 category registry JSON，而不是即時搜尋。",
    ...
    categoryDimensionDatasetDescription: "{label} 分類定義、計數和可抓取分類連結由預先計算 Blob category registry JSON 產生。",
    categoryDimensionCollectionName: "{label} 分類",
    categoryDimensionItemListName: "{label} 分類",
    categoryDimensionCapsule:
      "截至 {asOf}，GitStarClub 為已追蹤 GitHub 倉庫列出 {label} 維度下的 {categories} 個公開分類。此頁面由 category registry JSON 產生確定性計數和可抓取連結。",
    categoryDimensionQ: "{label} 分類頁包含什麼？",
    categoryDimensionAWithAsOf: "截至 {asOf}，{label} 頁面列出已追蹤 GitHub 倉庫的 {categories} 個公開分類。",
    categoryDimensionANoAsOf: "{label} 頁面從 registry JSON 列出已追蹤 GitHub 倉庫的 {categories} 個公開分類。",
    categoryLargestQ: "哪個 {label} 分類的追蹤倉庫最多？",
    categoryLargestA: "{category} 是可見 {label} 分類中最大的，有 {count} 個追蹤倉庫。",
    categoryLargestFallbackA: "已載入的 registry JSON 中沒有公開 {label} 分類計數。",
    ...
    categoryNoClientA: "不會。{label} 頁面由 Blob JSON 伺服器渲染，不為可見 FAQ 或分類連結加入客戶端篩選邏輯。",
    categoryDetailDatasetName: "GitStarClub {label} 倉庫資料集",
    categoryDetailDatasetDescription: "{label} 倉庫排名由預先計算 Blob category assignment、category rank 和 repository lookup JSON 產生。",
    categoryDetailCollectionName: "{label} 倉庫",
    categoryDetailItemListName: "{label} 倉庫",
    categoryDetailCapsule:
      "截至 {asOf}，GitStarClub 在 {label} 中追蹤 {count} 個倉庫。{leader}{followers}。此分類排名由確定性的 category assignment JSON、歷史總榜資料和 repository lookup 欄位產生。",
    ...
    categoryDetailDataA: "GitStarClub 組合 category assignment JSON、歷史總榜資料和 repository lookup 欄位。此頁面不會呼叫即時搜尋或 AI。",
  ...
  ko: {
    ...
    rankingDatasetDescription: "{label} GitHub 저장소 순위는 사용 가능한 사전 계산 Blob rank, lookup, heatmap JSON에서 생성됩니다.",
    ...
    rankingCapsule:
      "{asOf} 기준으로 {title}은 추적 GitHub 저장소를 {metric} 기준으로 정렬합니다. {leader}{followers}. GitStarClub은 런타임 검색, 데이터베이스, AI 없이 사전 계산 JSON과 lookup 조인으로 이 순위를 생성합니다.",
    rankingWhatQ: "{title}은 무엇을 순위화하나요?",
    rankingWhatAWithAsOf: "{asOf} 기준으로 {title}은 추적 GitHub 저장소를 {metric} 기준으로 순위화합니다.",
    rankingWhatANoAsOf: "{title}은 사전 계산 rank JSON에서 추적 GitHub 저장소를 {metric} 기준으로 순위화합니다.",
    ...
    rankingDataA: "아니요. GitStarClub은 서버 route가 이미 로드한 Blob rank JSON과 저장소 lookup JSON에서 {title}을 렌더링합니다.",
    categoryIndexDatasetName: "GitStarClub 카테고리 레지스트리 데이터셋",
    categoryIndexDatasetDescription: "공개 카테고리 차원, 카테고리 수, 크롤 가능한 카테고리 링크가 사전 계산 Blob category registry JSON에서 생성됩니다.",
    categoryIndexCollectionName: "GitHub 저장소 카테고리",
    categoryIndexItemListName: "GitHub 저장소 카테고리",
    categoryIndexCapsule:
      "{asOf} 기준으로 GitStarClub은 추적 GitHub 저장소를 {dimensions}개 차원, {categories}개 공개 카테고리로 정리합니다. 예: {labels}. 이 링크는 결정적 category registry JSON에서 나옵니다.",
    ...
    categoryIndexANoAsOf: "GitStarClub은 로드된 registry JSON에서 추적 저장소를 {dimensions}개 차원, {categories}개 공개 카테고리로 정리합니다.",
    categoryDimensionsQ: "사용 가능한 카테고리 차원은 무엇인가요?",
    categoryDimensionsA: "표시되는 카테고리 차원은 {labels}입니다.",
    categoryCountsQ: "카테고리 수는 어디서 오나요?",
    categoryCountsA: "카테고리 수는 저장소 메타데이터와 카테고리 규칙에서 생성된 결정적 category registry JSON에서 오며, 실시간 검색이 아닙니다.",
    ...
    categoryDimensionDatasetDescription: "{label} 카테고리 정의, 수, 크롤 가능한 링크가 사전 계산 Blob category registry JSON에서 생성됩니다.",
    categoryDimensionCollectionName: "{label} 카테고리",
    categoryDimensionItemListName: "{label} 카테고리",
    categoryDimensionCapsule:
      "{asOf} 기준으로 GitStarClub은 추적 GitHub 저장소의 {label} 차원에 공개 카테고리 {categories}개를 표시합니다. 이 페이지는 category registry JSON에서 결정적 수와 크롤 가능한 링크를 생성합니다.",
    ...
    categoryDimensionANoAsOf: "{label} 페이지는 registry JSON에서 추적 GitHub 저장소의 공개 카테고리 {categories}개를 표시합니다.",
    categoryLargestQ: "어떤 {label} 카테고리에 추적 저장소가 가장 많나요?",
    categoryLargestA: "{category}는 표시된 {label} 카테고리 중 가장 크며 추적 저장소 {count}개가 있습니다.",
    categoryLargestFallbackA: "로드된 registry JSON에 공개 {label} 카테고리 수가 없습니다.",
    ...
    categoryNoClientA: "아니요. {label} 페이지는 Blob JSON에서 서버 렌더링되며 표시 FAQ나 카테고리 링크에 클라이언트 필터링을 추가하지 않습니다.",
    categoryDetailDatasetName: "GitStarClub {label} 저장소 데이터셋",
    categoryDetailDatasetDescription: "{label} 저장소 순위는 사전 계산 Blob category assignment, category rank, repository lookup JSON에서 생성됩니다.",
    categoryDetailCollectionName: "{label} 저장소",
    categoryDetailItemListName: "{label} 저장소",
    categoryDetailCapsule:
      "{asOf} 기준으로 GitStarClub은 {label}에서 저장소 {count}개를 추적합니다. {leader}{followers}. 이 카테고리 순위는 결정적 category assignment JSON, 역대 순위 데이터, repository lookup 필드에서 생성됩니다.",
    ...
    categoryDetailDataA: "GitStarClub은 category assignment JSON, 역대 순위 데이터, repository lookup 필드를 결합합니다. 이 페이지는 실시간 검색이나 AI를 호출하지 않습니다.",
  ...
  es: {
    ...
    rankingDatasetDescription: "Rankings de repositorios GitHub {label} generados desde JSON Blob precalculado de rank, lookup y heatmap cuando está disponible.",
    ...
    rankingCapsule:
      "Al {asOf}, {title} ordena repositorios GitHub monitoreados por {metric}. {leader}{followers}. GitStarClub genera este ranking visible desde JSON precalculado y uniones lookup, sin búsqueda, base de datos ni IA en tiempo de ejecución.",
    rankingWhatQ: "¿Qué ordena {title}?",
    rankingWhatAWithAsOf: "Al {asOf}, {title} ordena repositorios GitHub monitoreados por {metric}.",
    rankingWhatANoAsOf: "{title} ordena repositorios GitHub monitoreados por {metric} desde JSON de ranking precalculado.",
    ...
    rankingDataA: "No. GitStarClub renderiza {title} desde Blob rank JSON y lookup JSON de repositorios ya cargados por la ruta del servidor.",
    categoryIndexDatasetName: "Dataset de registro de categorías GitStarClub",
    categoryIndexDatasetDescription: "Dimensiones públicas, conteos y enlaces rastreables de categorías generados desde category registry JSON Blob precalculado.",
    categoryIndexCollectionName: "Categorías de repositorios GitHub",
    categoryIndexItemListName: "Categorías de repositorios GitHub",
    categoryIndexCapsule:
      "Al {asOf}, GitStarClub organiza repositorios GitHub monitoreados en {categories} categorías públicas dentro de {dimensions} dimensiones, incluidas {labels}. Estos enlaces vienen de category registry JSON determinista.",
    ...
    categoryIndexANoAsOf: "GitStarClub organiza repositorios monitoreados en {categories} categorías públicas dentro de {dimensions} dimensiones en el registry JSON cargado.",
    ...
    categoryCountsA: "Los conteos vienen de category registry JSON determinista generado desde metadatos de repositorios y reglas de categoría, no de búsqueda en vivo.",
    ...
    categoryDimensionDatasetDescription: "Definiciones, conteos y enlaces rastreables de {label} generados desde category registry JSON Blob precalculado.",
    categoryDimensionCollectionName: "Categorías {label}",
    categoryDimensionItemListName: "Categorías {label}",
    categoryDimensionCapsule:
      "Al {asOf}, GitStarClub lista {categories} categorías públicas en la dimensión {label} para repositorios GitHub monitoreados. Esta página se genera desde category registry JSON con conteos deterministas y enlaces rastreables.",
    ...
    categoryDimensionANoAsOf: "La página {label} lista {categories} categorías públicas para repositorios GitHub monitoreados desde registry JSON.",
    ...
    categoryLargestFallbackA: "No hay conteos públicos de categoría {label} en el registry JSON cargado.",
    ...
    categoryNoClientA: "No. La página {label} se renderiza en servidor desde Blob JSON y no agrega filtrado cliente para la FAQ visible ni enlaces de categoría.",
    categoryDetailDatasetName: "Dataset de repositorios GitStarClub {label}",
    categoryDetailDatasetDescription: "Rankings de repositorios {label} generados desde Blob JSON precalculado de asignaciones, ranking de categoría y lookup de repositorios.",
    categoryDetailCollectionName: "Repositorios {label}",
    categoryDetailItemListName: "Repositorios {label}",
    categoryDetailCapsule:
      "Al {asOf}, GitStarClub monitorea {count} repositorios en {label}. {leader}{followers}. Este ranking de categoría se genera desde category assignment JSON determinista, datos de ranking histórico y campos lookup de repositorios.",
    ...
    categoryDetailDataA: "GitStarClub combina category assignment JSON, ranking histórico y campos lookup de repositorios. La página no llama búsqueda en vivo ni IA.",
  ...
  fr: {
    ...
    rankingDatasetDescription: "Classements de dépôts GitHub {label} générés depuis les JSON Blob précalculés de rank, lookup et heatmap lorsqu'ils sont disponibles.",
    ...
    rankingCapsule:
      "Au {asOf}, {title} classe les dépôts GitHub suivis par {metric}. {leader}{followers}. GitStarClub génère ce classement visible depuis des JSON précalculés et des jointures lookup, sans recherche, base de données ni IA à l'exécution.",
    rankingWhatQ: "Que classe {title} ?",
    rankingWhatAWithAsOf: "Au {asOf}, {title} classe les dépôts GitHub suivis par {metric}.",
    rankingWhatANoAsOf: "{title} classe les dépôts GitHub suivis par {metric} depuis un JSON de classement précalculé.",
    ...
    rankingDataA: "Non. GitStarClub rend {title} depuis le Blob rank JSON et le lookup JSON des dépôts déjà chargés par la route serveur.",
    categoryIndexDatasetName: "Jeu de données du registre de catégories GitStarClub",
    categoryIndexDatasetDescription: "Dimensions publiques, comptes et liens explorables de catégories générés depuis le category registry JSON Blob précalculé.",
    categoryIndexCollectionName: "Catégories de dépôts GitHub",
    categoryIndexItemListName: "Catégories de dépôts GitHub",
    categoryIndexCapsule:
      "Au {asOf}, GitStarClub organise les dépôts GitHub suivis en {categories} catégories publiques sur {dimensions} dimensions, dont {labels}. Ces liens proviennent d'un category registry JSON déterministe.",
    ...
    categoryIndexANoAsOf: "GitStarClub organise les dépôts suivis en {categories} catégories publiques sur {dimensions} dimensions dans le registry JSON chargé.",
    ...
    categoryCountsA: "Les comptes viennent d'un category registry JSON déterministe généré depuis les métadonnées de dépôts et les règles de catégorie, pas d'une recherche en direct.",
    ...
    categoryDimensionDatasetDescription: "Définitions, comptes et liens explorables {label} générés depuis le category registry JSON Blob précalculé.",
    categoryDimensionCollectionName: "Catégories {label}",
    categoryDimensionItemListName: "Catégories {label}",
    categoryDimensionCapsule:
      "Au {asOf}, GitStarClub liste {categories} catégories publiques dans la dimension {label} pour les dépôts GitHub suivis. Cette page est générée depuis le category registry JSON avec des comptes déterministes et des liens explorables.",
    ...
    categoryDimensionANoAsOf: "La page {label} liste {categories} catégories publiques pour les dépôts GitHub suivis depuis le registry JSON.",
    ...
    categoryLargestFallbackA: "Aucun compte public de catégorie {label} n'est disponible dans le registry JSON chargé.",
    ...
    categoryNoClientA: "Non. La page {label} est rendue côté serveur depuis Blob JSON et n'ajoute pas de filtrage client pour la FAQ visible ou les liens de catégorie.",
    categoryDetailDatasetName: "Jeu de données de dépôts GitStarClub {label}",
    categoryDetailDatasetDescription: "Classements de dépôts {label} générés depuis les Blob JSON précalculés d'affectation de catégorie, de classement de catégorie et de lookup de dépôts.",
    categoryDetailCollectionName: "Dépôts {label}",
    categoryDetailItemListName: "Dépôts {label}",
    categoryDetailCapsule:
      "Au {asOf}, GitStarClub suit {count} dépôts dans {label}. {leader}{followers}. Ce classement de catégorie est généré depuis un category assignment JSON déterministe, des données de classement historique et les champs lookup de dépôts.",
    ...
    categoryDetailDataA: "GitStarClub combine category assignment JSON, données de classement historique et champs lookup de dépôts. La page n'appelle ni recherche en direct ni IA.",
