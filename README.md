...
| Stack | Next.js 16 (App Router, RSC, Turbopack) · TypeScript 6 · React 19 · Zod 4 · Tailwind 4 · bun · Node 24 |
...
| Data scope | Public repos with ≥10,000 stars (~5,300), 2015-01 to present |
...
├── README.md
├── docs/                          Documentation
│   └── README.md                  Index with reading order and ownership map
├── pipeline/backfill/             One-off bootstrap (archived; recurring refresh runs in Vercel Workflow)
└── web/                           Next.js 16 application
    ...
    │   └── _explore/              Server components: Chrome, SearchBox, RankingList, Heatmap,
    │                              StarCurve, CompareCurve, Breadcrumbs, Footer, JsonLd, …
    ├── lib/
