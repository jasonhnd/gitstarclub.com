...
The target-query registry lives at [docs/geo/queries.md](./geo/queries.md). It lists real prompts GitStarClub should win, grouped by page type:
...
- Start with query coverage for repo, org, ranking, category, pulse, and compare pages; add about/methodology and data-export citation queries when those surfaces enter manual review.
