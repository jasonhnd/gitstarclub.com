...
原则：**最短、可读、SEO 友好**。三语：英文根 / `/ja/...` / `/zh/...`。

## 核心页面（编年史 + 脉搏两面）

> **编年史面**：首页/年/月/周/repo/org/全时榜——回看，多为冻结 / 标 "as of 日期"。**脉搏面**：`/trending` + 首页"现在在涨"区——每日刷新"谁在涨/老项目复活"（新鲜度模型见 [REQUIREMENTS §6](./REQUIREMENTS.md)）。
