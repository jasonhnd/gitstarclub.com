...
| Pipeline publication tests | `enforced` | GitHub Actions PR/`pre`/`main`：`pipeline/bun run test` | Interrupted uploads, resume, validation failure, lease fencing, single-pointer commit, and explicit rollback replay |
